...
<template>
  <section
    class="section-c min-h-screen l-article bg-love-blue-01 relative overflow-x-hidden pt-12 sm:pt-20 rounded-t-[70px] -mt-[70px] sm:rounded-t-[100px] sm:-mt-[100px] lg:rounded-t-[120px] lg:-mt-[120px]"
  >
    <!-- Title -->
